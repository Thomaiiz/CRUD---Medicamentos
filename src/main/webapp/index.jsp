...
<body>
	<header>
		...
		<nav>
			<a href="#">Home</a> <a href="#">Medicamentos</a> <a
				href="sobre.html">Sobre o Sistema</a> <a href="#">Contato</a>
		</nav>
		<div>
			🔍
			<%
		...
		%>
			...
			<a href="cadastromedicamentos.jsp"
				style="background: #007BFF; color: white; padding: 5px 10px; border-radius: 5px; text-decoration: none; margin-right: 10px;">Cadastrar
	...
	<main style="padding: 40px; background: #fff; color: #333;">
		...
		<div
			...
			%>
			<div
				style="width: 220px; background: #f4f4f4; border-radius: 8px; padding: 15px; text-align: center;">
				<img src="img/<%=m.getImagem()%>"
					style="width: 100%; height: auto; border-radius: 8px;">
				<h3>
					<a href="detalhes.jsp?nome=<%=m.getNomeComercial()%>"
						style="text-decoration: none; color: #1db954;"> <%=m.getNomeComercial()%>
					</a>
				</h3>
				...
				<a href="editar.jsp?nome=<%=m.getNomeComercial()%>"
					style="display: inline-block; margin-top: 10px; padding: 5px 10px; background: #ffc107; color: black; text-decoration: none; border-radius: 5px;">Editar</a>
				<%
				}
				%>
